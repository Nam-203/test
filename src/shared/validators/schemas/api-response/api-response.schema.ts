...
export const ApiErrorSchema = <T extends z.ZodTypeAny = z.ZodTypeAny>(
	dataSchema: T,
) =>
	MessageOnlySchema.merge(
		z.object({
...
export type TApiResponse<T extends z.ZodTypeAny = z.ZodTypeAny> = z.infer<
	ReturnType<typeof ApiResponseSchema<T>>
>;
export type TApiError<T extends z.ZodTypeAny = z.ZodTypeAny> = z.infer<
	ReturnType<typeof ApiErrorSchema<T>>
>;
